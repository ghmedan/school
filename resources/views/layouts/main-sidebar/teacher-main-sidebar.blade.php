<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- الاقسام-->
        <li>
            <a href="{{ url('sections_index') }}"><i class="fas fa-chalkboard"></i><span
                    class="right-nav-text">الاقسام</span></a>
        </li>

        <!-- الطلاب-->
        <li>
            <a href="{{ url('students_index') }}"><i class="fas fa-user-graduate"></i><span
        ...
        <li>
            ...
            <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{ url('quizze_index') }}">قائمة الاختبارات</a></li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('onlineclass_index') }}">حصص اونلاين مع زوم</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            ">
                ...
                <span class="right-nav-text">الملف
                    الشخصي</span></a>
        </li>
