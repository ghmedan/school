        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <button type="button" class="button x-small" data-toggle="modal" data-target="#exampleModal">
                    <th>{{ trans('Grades_trans.add_grade') }}</th>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ url('/grades_update') }}" method="POST">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="Name"
                                                            ...
                                                            <input id="id" type="hidden" name="id"
                                                                value="{{ $grade->id }}" class="form-control">
                                ...
                                <div class="modal fade" id="delete{{ $grade->id }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- add_form -->
                                                <form action="{{ url('/grades_delete') }}" method="POST">
                                                    @csrf
                                                    {{ trans('Grades_trans.werning_grade') }}
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">{{ trans('Grades_trans.close') }}</button>
                                                <button type="submit"
                                                    class="btn btn-success">{{ trans('Grades_trans.delete') }}</button>
                                            </div>
                                            </form>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- add_form -->
                    <form action="{{ url('/grades_store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col">
