        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('quizzes_create') }}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <tbody>
                                        @foreach ($quizzes as $quizze)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('quizzes_edit',$quizze->id)}}"
                                                    ...
                                                    <a href="{{route('quizzes_show',$quizze->id)}}"
                                            ...
                                            <div class="modal fade" id="delete_exam{{ $quizze->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('quizzes_destroy',$quizze->id)}}" method="post">
                                                   @csrf
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 style="font-family: 'Cairo', sans-serif;"
                                                                class="modal-title" id="exampleModalLabel">حذف اختبار
                                                            </h5>
